...
from ._utils.abi import abi_to_signature, check_if_arguments_can_be_encoded, fallback_func_abi_exists, filter_by_type, \
    get_abi_input_names, get_abi_input_types, get_abi_output_types, get_constructor_abi, is_array_type, map_abi_data, \
    merge_args_and_kwargs, receive_func_abi_exists
from ._utils.blocks import is_hex_encoded_block_hash
from ._utils.contracts import encode_abi, find_matching_event_abi, find_matching_fn_abi, get_function_info, \
    prepare_transaction
from ._utils.datatypes import PropertyCheckingFactory
from ._utils.decorators import deprecated_for
from ._utils.empty import empty
from ._utils.encoding import to_4byte_hex, to_hex
from ._utils.events import EventFilterBuilder, get_event_data, is_dynamic_sized_type
from ._utils.filters import LogFilter, construct_event_filter_params
from ._utils.function_identifiers import FallbackFn, ReceiveFn
from ._utils.normalizers import BASE_RETURN_NORMALIZERS, normalize_abi, normalize_address, normalize_bytecode
from ._utils.transactions import fill_transaction_defaults
from tree_graph.contract.web3.datastructures import (
    AttributeDict,
...
from tree_graph.contract.web3.logs import (
    DISCARD,
    IGNORE,
    STRICT,
    WARN,
...
class ContractFunction:
    ...
    def call(
        ...
        """
        Execute a contract function call using the `cfx_call` interface.
