...
if TYPE_CHECKING:
    ...
    from tree_graph.contract.web3 .contract import Contract  # noqa: F401
...
class AsyncEthModuleTest:
    ...
    @pytest.mark.asyncio
    async def test_cfx_call_with_override(
    ...
    @pytest.mark.asyncio
    async def test_cfx_call_with_0_result(
        self, async_w3: "Web3", math_contract: "Contract"
    ) -> None:
        coinbase = await async_w3.eth.coinbase  # type: ignore
        txn_params = math_contract._prepare_transaction(
    ...
    @pytest.mark.asyncio
    async def test_cfx_call_revert_with_msg(
        self,
        async_w3: "Web3",
    ...
    @pytest.mark.asyncio
    async def test_cfx_call_revert_without_msg(
        self,
        async_w3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
...
class EthModuleTest:
    ...
    def test_cfx_call_with_override(
    ...
    def test_cfx_call_with_0_result(
        self, web3: "Web3", math_contract: "Contract"
    ) -> None:
        coinbase = web3.eth.coinbase
        txn_params = math_contract._prepare_transaction(
    ...
    def test_cfx_call_revert_with_msg(
        self,
        web3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_cfx_call_revert_without_msg(
        self,
        web3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_cfx_call_old_contract_state(
